...
![Screenshot of the full output of the exiftool](assets/exiftool-full.png)
...
![Screenshot of the full output of the exiftool](assets/twitter-full.png)
![Screenshot of the full output of the exiftool](assets/github.png)
...
![Screenshot of the full output of the exiftool](assets/location.png)
...
![Screenshot of the full output of the exiftool](assets/source-code.png)
